...
public class MQTTHelper {
    ...
    public final String[] arrayTopics = {"An3003/feeds/cambien1", "An3003/feeds/cambien2", "An3003/feeds/nutnhan1", "An3003/feeds/nutnhan2"};

    final String clientId = "123456789";
    final String username = "An3003";
    final String password = "aio_tUcc249TgXE7XefWVtqTsI5jLnBs";
